...
/**
 * 
 * <p>Title: CupMerchantInfoModel</p>
 * <p>Description:直联商户数据模型</p>
 * <p>Company: eh</p>
 * @author li liang zhong
 * @date 2019年3月27日 上午9:29:51
 * @version 1.0
 *
 */
public class CupMerchantInfoModel implements Serializable
{
	...
	/** 所属平台机构代码 */
	@Parsed(field = "所属平台机构代码")
	private String platInsIdCd;
	
	/** 收单接入机构代码 */
	@Parsed(field = "收单接入机构代码")
	...
	/** 法人代表证件类型 */
	@Parsed(field = "法人代表证件类型")
	private String artifCertifTp;
	
	/** 法人代表证件号码 */
	@Parsed(field = "法人代表证件号")
	...
	/** 商户开户行名称 */
	@Parsed(field = "商户开户行名称")
	private String bankNm1;
	
	/** 商户开户行行号 */
	@Parsed(field = "商户开户行行号")
	private String bankSettleNo1;
	
	/** 开户行接收行行号 */
	@Parsed(field = "开户行接收行行号")
	...
	/** 商户费用开户行名称 */
	@Parsed(field = "商户费用开户行名称")
	private String mchntFeeBankNm;
	
	/** 商户费用账号开户行行号 */
	@Parsed(field = "商户费用账号开户行行号")
	...
	/** 商户费用账户名称 */
	@Parsed(field = "商户费用账户名称")
	private String mchntFeeAcctNm;
	
	/** 商户费用开户行清算号 */
	@Parsed(field = "商户费用开户行清算号")
	private String mchntFeeSettleBankCd;
	
	/** 商户费用结算行机构代码 */
	@Parsed(field = "商户费用结算行机构代码")
	...
	/** 委托关系是否允许覆盖 */
	@Parsed(field = "委托关系是否允许覆盖")
	private String entrustRelationIn;
	
	/** 增加主动委托关系标志 */
	@Parsed(field = "增加主动委托关系标志")
	...
	/** 单卡单日累计限额 */
	@Parsed(field = "单卡单日累计限额")
	private String singleCardDayAtLimit;
	
	/** 单卡单日累计限额说明 */
	@Parsed(field = "单卡单日累计限额说明")
	...
	/** 业务联系人固话 */
	@Parsed(field = "业务联系人固话")
	private String bussCont1Tel;
	
	/** 业务联系人移动电话 */
	@Parsed(field = "业务联系人移动电话")
	private String bussCont1Cell;
	
	/** 业务联系人邮箱 */
	@Parsed(field = "业务联系人邮箱")
	...
	/** 外卡收单行代码 */
	@Parsed(field = "外卡收单行代码")
	private String frnAcqInsIdCd;
	
	/** 第三方服务机构代码 */
	@Parsed(field = "第三方服务机构代码")
	private String insResv8;
	
	/** 是否向商户收取服务费 */
	@Parsed(field = "是否向商户收取服务费")
	private String svcFeeIn;
	
	/** 是否开展分期付款 */
	@Parsed(field = "是否开展分期付款")
